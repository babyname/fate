...
var regularList = map[int]string{
	...
	3: `三、于、干、亏、士、工、土、才、寸、下、大、丈、与、万、上、小、
	口、巾、山、千、乞、川、亿、个、勺、久、凡、及、夕、丸、么、广、
	亡、门、义、之、尸、弓、己、已、子、卫、也、女、飞、刃、习、叉、
	马、乡`,
	4: `丰、王、井、开、夫、天、无、元、专、云、扎、艺、木、五、支、厅、
	...
	队、办、以、允、予、劝、双、书、幻`,
	5: `玉、刊、示、末、未、击、打、巧、正、扑、扒、功、扔、去、甘、世、
	...
	孕、圣、对、台、矛、纠、母、幼、丝`,
	6: `式、刑、动、扛、寺、吉、扣、考、托、老、执、巩、圾、扩、扫、地、
	...
	买、红、纤、级、约、纪、驰、巡`,
	7: `寿、弄、麦、形、进、戒、吞、远、违、运、扶、抚、坛、技、坏、扰、
	...
	驳、纵、纷、纸、纹、纺、驴、纽`,
	8: `奉、玩、环、武、青、责、现、表、规、抹、拢、拔、拣、担、坦、押、
	...
	终、驻、驼、绍、经、贯`,
	9: `奏、春、帮、珍、玻、毒、型、挂、封、持、项、垮、挎、城、挠、政、
	...
	10: `耕、耗、艳、泰、珠、班、素、蚕、顽、盏、匪、捞、栽、捕、振、载、
	...
	11: `球、理、捧、堵、描、域、掩、捷、排、掉、堆、推、掀、授、教、掏、
	...
	绿`,
	12: `琴、斑、替、款、堪、搭、塔、越、趁、趋、超、提、堤、博、揭、喜、
	...
	登、缎、缓、编、骗、缘`,
	13: `瑞、魂、肆、摄、摸、填、搏、塌、鼓、摆、携、搬、摇、搞、塘、摊、
	...
	14: `静、碧、璃、墙、撇、嘉、摧、截、誓、境、摘、摔、聚、蔽、慕、暮、
...
func fixRegular(db fate.Database, ch string) bool {
	...
	update, e := engine.Where("hash = ?", char.Hash).Cols("regular").Update(char)
	if e != nil {
		return false
	}
	if update == 0 {
