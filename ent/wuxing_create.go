...
func (wxc *WuXingCreate) Save(ctx context.Context) (*WuXing, error) {
	...
	if len(wxc.hooks) == 0 {
		...
		if _, err := mut.Mutate(ctx, wxc.mutation); err != nil {
			return nil, err
		}
	}
	return node, err
...
// SetVersion sets the "version" field.
func (u *WuXingUpsert) SetVersion(v int32) *WuXingUpsert {
...
func (u *WuXingUpsert) AddVersion(v int32) *WuXingUpsert {
...
// SetVersion sets the "version" field.
func (u *WuXingUpsertOne) SetVersion(v int32) *WuXingUpsertOne {
	return u.Update(func(s *WuXingUpsert) {
		s.SetVersion(v)
	})
}
...
// AddVersion adds v to the "version" field.
func (u *WuXingUpsertOne) AddVersion(v int32) *WuXingUpsertOne {
	return u.Update(func(s *WuXingUpsert) {
		s.AddVersion(v)
	})
}
...
// SetVersion sets the "version" field.
func (u *WuXingUpsertBulk) SetVersion(v int32) *WuXingUpsertBulk {
	return u.Update(func(s *WuXingUpsert) {
		s.SetVersion(v)
	})
}
...
// AddVersion adds v to the "version" field.
func (u *WuXingUpsertBulk) AddVersion(v int32) *WuXingUpsertBulk {
	return u.Update(func(s *WuXingUpsert) {
		s.AddVersion(v)
	})
}
