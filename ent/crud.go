...
func (nc *NCharacterCreate) SetNCharacter(input *NCharacter) *NCharacterCreate {
	...
	nc.SetCh(input.Ch)
	nc.SetChStroke(input.ChStroke)
	nc.SetChType(input.ChType)
	nc.SetRadical(input.Radical)
	nc.SetRadicalStroke(input.RadicalStroke)
	nc.SetRelate(input.Relate)
	...
	nc.SetIsNameScience(input.IsNameScience)
	nc.SetNameScienceChStroke(input.NameScienceChStroke)
...
func (nuo *NCharacterUpdateOne) SetNCharacter(input *NCharacter) *NCharacterUpdateOne {
	...
	nuo.SetCh(input.Ch)
	nuo.SetChStroke(input.ChStroke)
	nuo.SetChType(input.ChType)
	nuo.SetRadical(input.Radical)
	nuo.SetRadicalStroke(input.RadicalStroke)
	nuo.SetRelate(input.Relate)
	...
	nuo.SetIsNameScience(input.IsNameScience)
	nuo.SetNameScienceChStroke(input.NameScienceChStroke)
...
func (nu *NCharacterUpdate) SetNCharacter(input *NCharacter) *NCharacterUpdate {
	...
	nu.SetCh(input.Ch)
	nu.SetChStroke(input.ChStroke)
	nu.SetChType(input.ChType)
	nu.SetRadical(input.Radical)
	nu.SetRadicalStroke(input.RadicalStroke)
	nu.SetRelate(input.Relate)
	...
	nu.SetIsNameScience(input.IsNameScience)
	nu.SetNameScienceChStroke(input.NameScienceChStroke)
