...
func (wglgb *WuGeLuckyGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (wglgb *WuGeLuckyGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (wgls *WuGeLuckySelect) Scan(ctx context.Context, v interface{}) error {
...
func (wgls *WuGeLuckySelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
