...
func (wxgb *WuXingGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (wxgb *WuXingGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (wxs *WuXingSelect) Scan(ctx context.Context, v interface{}) error {
...
func (wxs *WuXingSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
